...
namespace Tag.WPF
{
    public class CueSplitModel : TrackInfo
    {
        ...
        public string Duration => DurationMS == -1 ? Global.Language.CueSongLength : $"{(int)(DurationMS / 60 / 1000)}{Global.Language.CueMin} : {(int)(DurationMS / 1000 % 60)}{Global.Language.CueSecond} : {(int)(DurationMS % 1000)}{Global.Language.CueMiliSecond}";
